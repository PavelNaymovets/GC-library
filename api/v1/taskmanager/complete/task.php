<?php
    ...
    /** 
    * Endpoint для завершения задачи пользователя в БД:
    * 
    * https://hmns.in/hmnsgc/projects/toTheYard/api/v1/taskmanager/complete/task.php?taskId=1&uid=1&week=0
    * 
    ...
    */
    ...
    require_once '../../../../workWithDataBase/TaskManagerDB/TaskCompliter.php';
    ...
    $taskCompliter = new TaskCompliter($executorQuery, $taskReturner);
    ...
    $result = $taskCompliter->taskIsDone($taskId, $uid, $week);
